...
class BooleanTypeResolver implements SchemaTypeResolverInterface
{
    /**
    ...
    {
        return RestApiBundle\Model\Mapper\Schema::createTransformerType(RestApiBundle\Services\Mapper\Transformer\BooleanTransformer::class, $propertyInfoType->isNullable());
    }
}
