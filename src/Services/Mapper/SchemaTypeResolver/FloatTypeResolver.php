...
class FloatTypeResolver implements SchemaTypeResolverInterface
{
    /**
    ...
    {
        return RestApiBundle\Model\Mapper\Schema::createTransformerType(RestApiBundle\Services\Mapper\Transformer\FloatTransformer::class, $propertyInfoType->isNullable());
    }
}
