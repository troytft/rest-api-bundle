...
class ConfigExtension extends Extension
{
    ...
    public const PARAMETER_REQUEST_MODEL_HANDLE_MAPPING_EXCEPTION = 'rest_api.request_model.handle_mapping_exception';
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter(static::PARAMETER_REQUEST_MODEL_HANDLE_MAPPING_EXCEPTION, $config['request_model']['handle_mapping_exception']);
