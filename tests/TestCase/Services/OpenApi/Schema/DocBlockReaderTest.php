...
class DocBlockReaderTest extends Tests\TestCase\BaseTestCase
{
    ...
    public function testMethodWithNullReturnTag()
    {
        ...
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Types\NullType::class, $returnType);
    }
    ...
    public function testSingleResponseModelReturnTag()
    {
        ...
        /** @var RestApiBundle\DTO\OpenApi\Types\ClassType $returnType */
        $returnType = $this->getDocBlockSchemaReader()->getMethodReturnSchema($reflectionMethod);

        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Types\ClassType::class, $returnType);
    ...
    public function testArrayOfResponseModelsReturnTag()
    {
        ...
        /** @var RestApiBundle\DTO\OpenApi\Types\ArrayType $returnType */
        $returnType = $this->getDocBlockSchemaReader()->getMethodReturnSchema($reflectionMethod);
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Types\ArrayType::class, $returnType);
        $this->assertFalse($returnType->getNullable());

        /** @var RestApiBundle\DTO\OpenApi\Types\ClassType $innerType */
        $innerType = $returnType->getInnerType();
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Types\ClassType::class, $innerType);
