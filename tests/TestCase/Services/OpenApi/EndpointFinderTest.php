...
class EndpointFinderTest extends Tests\TestCase\BaseTestCase
{
    ...
    public function testAllowedScalarPathParameters()
    {
        ...
        $this->assertCount(2, $endpointData->getRoutePathParameters());

        $this->assertSame('int', $endpointData->getRoutePathParameters()[0]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\IntegerType::class, $endpointData->getRoutePathParameters()[0]->getSchema());
        $this->assertFalse($endpointData->getRoutePathParameters()[0]->getSchema()->getNullable());

        $this->assertSame('string', $endpointData->getRoutePathParameters()[1]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\StringType::class, $endpointData->getRoutePathParameters()[1]->getSchema());
        $this->assertFalse($endpointData->getRoutePathParameters()[1]->getSchema()->getNullable());
    }
    ...
    public function testEntityPathParameters()
    {
        ...
        $this->assertCount(4, $endpointData->getRoutePathParameters());

        $this->assertSame('int', $endpointData->getRoutePathParameters()[0]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\IntegerType::class, $endpointData->getRoutePathParameters()[0]->getSchema());

        $this->assertSame('genre', $endpointData->getRoutePathParameters()[1]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\IntegerType::class, $endpointData->getRoutePathParameters()[1]->getSchema());

        $this->assertSame('string', $endpointData->getRoutePathParameters()[2]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\StringType::class, $endpointData->getRoutePathParameters()[2]->getSchema());

        $this->assertSame('slug', $endpointData->getRoutePathParameters()[3]->getName());
        $this->assertInstanceOf(RestApiBundle\DTO\OpenApi\Schema\StringType::class, $endpointData->getRoutePathParameters()[3]->getSchema());
    }
